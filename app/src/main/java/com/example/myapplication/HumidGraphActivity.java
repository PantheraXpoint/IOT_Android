...
//                overridePendingTransition(R.anim.slide_out_right,R.anim.slide_in_left);
    ...
    private void startRun(){
        ...
        Runnable runnable  = ()->{
            WeatherDataService weatherDataService = new WeatherDataService(HumidGraphActivity.this);
            weatherDataService.getLastdata(tempUrl, new WeatherDataService.VolleyResponseListener() {
                @Override
                public void onError(String message) {
                    Toast.makeText(HumidGraphActivity.this, "Something wrong!!", Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onResponse(String temp) {
                    if(parseInt(temp) != tempAPI) {
                        Toast.makeText(HumidGraphActivity.this, "Return temp: " + temp, Toast.LENGTH_SHORT).show();
